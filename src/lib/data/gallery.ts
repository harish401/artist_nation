...
export const galleryItems: GalleryItem[] = [
  {
    id: "1",
    title: "Asian paints dealer meet",
    category: "Launch",
  ...
  {
    id: "3",
    title: "Loreal international Summit",
    category: "Production",
  ...
  {
    id: "7",
    title: "Lamborghini premium Car launch ",
    category: "Automotive",
  ...
  {
    id: "16",
    title: "⁠⁠Mercedes Benz drive for new launched cars ",
    category: "Corporate",
  ...
  {
    id: "17",
    title: "Mall activation with Nykaa",
    category: "Production",
  ...
  {
    id: "18",
    title: "⁠MC interaction with crowd for Events ",
    category: "Entertainment",
  ...
  {
    id: "19",
    title: "Mall activation for Toyota Yaris",
    category: "Automotive",
  ...
  {
    id: "20",
    title: "⁠⁠Employee meet with leadership team participation",
    category: "Corporate",
  ...
  {
    id: "21",
    title: "Lambougini car launch with display",
    category: "Corporate",
